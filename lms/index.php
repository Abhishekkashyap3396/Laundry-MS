...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">Laundry Management System</a>
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="index.php">Laundry Management System</a>
          </li>
          <li class="breadcrumb-item active">Welcome Page</li>
        </ol>

        <!-- Page Content -->
        <h2>Welcome Back to Laundry Management System</h2>
        <hr>
        <p>Laundry Management System (LMS) Developed in PHP and Mysql </p>
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © Laundry Management System (LMS) 2023</span>
          </div>
        </div>
      </footer>
